...
export const Privacy = () => {
  return (
    <div className='ourMission'>
      <h1 className='ourMission__title'>Privacy Policy</h1>
      <p>
      ...
      <ul className='privacyUl'>
        ...
        <li>
          <strong>Website</strong> refers to Concordspirit INC, accessible from{' '}
        </li>
        <li>
      ...
      <ul className='privacyUl'>
        <li>
          <strong>Necessary / Essential Cookies</strong>Purpose: These Cookies
        ...
        <li>
          <strong>Cookies Policy / Notice Acceptance Cookies</strong>Purpose:
